...
Before I became a software engineer, I studied people.

My foundation in **digital marketing and user behavior analysis** taught me how users think, decide, and interact with products. That understanding now drives everything I build.

Today, I design **AI-powered systems, automation pipelines, and data-driven applications** that are shaped around real human behavior—not just technical requirements.

I don’t just build features.  
I build systems that respond to users intelligently.

---

## 🔍 The Problem I Focus On

Most AI and software systems fail at one thing:  
they are built for logic, not for people.

I focus on bridging that gap by building systems that:

- translate user behavior into system intelligence
- reduce friction through automation
- turn data into decisions, predictions, and actions
- align product logic with real human intent
...
Models and workflows that adapt to context, behavior, and real-world usage patterns.

⚙️ **Automation Engineering**  
Systems that eliminate repetitive workflows and scale human effort efficiently.

📊 **Data-Driven Applications**  
Tools that transform raw data into insights, predictions, and business decisions.

🎯 **User-Centric Architecture**  
Backend + AI systems designed around real user journeys and outcomes.

---

## ⚡ Why This Approach Works

My engineering mindset is shaped by two domains:

- **Marketing → understanding user psychology**
- **Software Engineering → building scalable intelligent systems**

This combination allows me to design products that are:
...
🧾 **DocManager** – Full-stack document management system with secure APIs, version control, and access control  
🤖 **AutoWA** – WhatsApp automation platform with behavior simulation and workflow orchestration  
✍️ **Autowritey** – AI content generation pipeline with style modeling, validation loops, and factual grounding
⚡ **Fraud Detection System** – ML pipeline for imbalanced datasets achieving ~0.85 performance metrics
